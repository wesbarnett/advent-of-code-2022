...
if __name__ == "__main__":
    ...
    for line in lines:
        ...
        if (
            ...
            or (
                int(assign1_low) <= int(assign2_low)
                and int(assign1_high) >= int(assign2_low)
            )
            or (
                int(assign2_low) <= int(assign1_low)
                and int(assign2_high) >= int(assign1_low)
            )
            or (
                int(assign1_high) >= int(assign2_high)
                and int(assign1_low) <= int(assign2_high)
            )
            or (
                int(assign2_high) >= int(assign1_high)
                and int(assign2_low) <= int(assign1_high)
            )
        ):
            total += 1
    print(total)
